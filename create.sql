...
create table matches (match_id uuid not null, match_name varchar(255), player_loser varchar(255), player_winner varchar(255), round_id uuid, team_loser varchar(255), team_winner varchar(255), primary key (match_id));
